...
def parse_args():
    ...
    parser.add_argument('--save_dir', default='/data/shufan/shufan/mmaction2/tools/clip_inference/timesformer_entity.json')
    ...
    parser.add_argument('--data_split_dir', default='/data/shufan/shufan/mmaction2/tools/clip_inference/probing_split', help='split file dir')
...
#                item_emb_dict = self.emb_dict[self.class_name][video_name]
            ...
            if 'feature' in item_emb_dict.keys():
                ...
                if self.layer in item_emb_dict.keys():
                ...
                elif 'module.{}'.format(self.layer) in item_emb_dict.keys():
                    if 'slow' in self.layer:
                    ...
                    print('Missing keys {}'.format(self.layer))
...
if __name__=="__main__":
    ...
    for data_split_file in os.listdir(data_split_dir):
        ...
        data_split_path = os.path.join(data_split_dir, data_split_file)
        file_head = '.'.join(data_split_file.split('.')[:-1])
        data_split = load_json(data_split_path)
        save_path = os.path.join(save_dir, '{}_{}.json'.format(args.model_name, file_head))
            ...
            for class_name in class_name_list:
                ...
                for layer in layer_list:
                    ...
                    try:
                        ...
                        print('{}_{}_{} only have one class'.format(file_head, class_name, layer))
        else:
