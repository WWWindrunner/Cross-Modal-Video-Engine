...
from utils import save_pkl, load_pkl, inference_pytorch_instance
...
def main():
    ...
    print('test ann file {}'.format(cfg.data.test.ann_file))
    ...
    returned_grads_dict = inference_pytorch_instance(args, cfg, distributed, data_loader)
