...
model = dict(
    ...
    backbone=dict(
        type='MViT',
        cfg_path='/data/shufan/shufan/mmaction2/configs/recognition/SlowFast_cfg/MVIT_B_32x3_CONV.yaml',
        no_grad=True),# for gramcam
    cls_head=dict(
...
load_from='/data/shufan/shufan/mmaction2/checkpoints/mmaction_checkpoints/mvit_k400.pyth'
gpu_ids = [0]
# dataset settings
