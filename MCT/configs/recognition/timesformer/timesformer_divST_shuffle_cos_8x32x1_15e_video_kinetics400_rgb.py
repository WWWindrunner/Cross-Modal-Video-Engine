...
model = dict(
    ...
    cls_head=dict(type='TimeSformerHead', loss_cls=dict(type='CrossEntropy_COSLoss', margin=0.5, cos_weight=0.00), num_classes=400, in_channels=768),
...
work_dir = './work_dirs/k400_timesformer_divST_shuffle_8x32x1_15e_video_kinetics400_rgb'
