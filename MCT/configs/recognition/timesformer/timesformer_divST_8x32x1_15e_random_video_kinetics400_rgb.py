...
model = dict(
    ...
    backbone=dict(
        type='TimeSformer',
        pretrained='/data1/shufan/mmaction2/vit_base_patch16_224.pth',
        num_frames=8,
        img_size=224,
        patch_size=16,
        embed_dims=768,
...
train_pipeline = [
    ...
    dict(type='RandomShuffleFrames', shuffle_idx='adaptive')
]
val_pipeline = [
    dict(type='DecordInit'),
    dict(
...
work_dir = './work_dirs/random_timesformer_divST_8x32x1_15e_video_kinetics400_rgb'
