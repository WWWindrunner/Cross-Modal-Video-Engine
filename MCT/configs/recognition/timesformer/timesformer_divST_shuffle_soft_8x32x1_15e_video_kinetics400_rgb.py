...
# model settings
model = dict(
    type='Recognizer3D_shuffle_soft',
    backbone=dict(
        type='TimeSformer',
    ...
    cls_head=dict(type='TimeSformerHead', loss_cls=dict(type='CrossEntropy_SoftLoss', margin=margin, soft_weight=soft_weight), num_classes=400, in_channels=768),
...
work_dir = './work_dirs/k400_timesformer_divST_shuffle_soft_{}_{}_8x32x1_15e_video_kinetics400_rgb'.format(margin, soft_weight)
