...
# model settings
model = dict(
    type='Recognizer3D_shuffle_extra',
    backbone=dict(
        type='TimeSformer',
    ...
    cls_head=dict(type='TimeSformerHead', num_classes=401, in_channels=768),
...
work_dir = './work_dirs/k400_timesformer_divST_shuffle_extra_8x32x1_15e_video_kinetics400_rgb'
