...
model = dict(
    ...
    backbone=dict(
        ...
        frozen_stages=11,
        no_grad=True),
    cls_head=dict(type='TimeSformerHead', num_classes=16, in_channels=768),
...
evaluation = dict(
    interval=1, metrics=['top_k_accuracy', 'mean_class_accuracy', 'all_class_accuracy'])
...
work_dir = './work_dirs/timesformer/layers/contact/cav_timesformer_11layer_divST_8x32x1_15e_contact_rgb'
