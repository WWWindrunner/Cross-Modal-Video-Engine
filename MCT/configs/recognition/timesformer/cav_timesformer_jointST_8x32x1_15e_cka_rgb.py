...
load_from = '/data1/shufan/mmaction2/checkpoints/mmaction_checkpoints/timesformer_jointST_8x32x1_15e_kinetics400_rgb-0d6e3984.pth'
# dataset settings
...
ann_file_val = '/data1/shufan/mmaction2/data/Charades/not_looking_at_relation_ann.txt'
ann_file_test = '/data1/shufan/mmaction2/data/Charades/looking_at_relation_ann.txt'
...
#data_root_test = '/data1/shufan/mmaction2/data/ActivityNet/rawvideos_val'
...
#ann_file_test = '/data1/shufan/mmaction2/data/ActivityNet/activitynet_val_list_rawvideos.txt'
img_norm_cfg = dict(
...
work_dir = './work_dirs/cav_timesformer_jointST_8x32x1_15e_cka_rgb'
