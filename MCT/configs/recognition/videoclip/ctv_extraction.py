...
model = dict(
    ...
    backbone=dict(
        type='VideoCLIP',
        config_path="/data/shufan/shufan/fairseq/examples/MMPT/projects/retri/videoclip/how2.yaml",
        no_grad=True),
    cls_head=dict(type='TimeSformerHead', num_classes=400, in_channels=768),
    # model training and testing settings
    train_cfg=None,
    test_cfg=dict(average_clips='prob'))
load_from='/data/shufan/shufan/mmaction2/checkpoints/mmaction_checkpoints/videomae_b_k400.pth'
gpu_ids = [0]
...
train_pipeline = [
    ...
    dict(type='SampleFrames', clip_len=300, frame_interval=1, num_clips=1),
