...
model = dict(
    ...
    cls_head=dict(
        type='I3DHead',
        loss_cls=dict(type='CrossEntropy_COSLoss', margin=0.5, cos_weight=0.01),
        num_classes=400,
        in_channels=2048,
        spatial_type='avg',
        dropout_ratio=0.5,
    ...
    train_cfg=dict(aux_info=['shuffle_imgs'], _delete_=True),
...
# runtime settings
work_dir = './work_dirs/i3d_r50_video_shuffle_3d_32x2x1_100e_kinetics400_rgb/'
