...
class TransformerBasicHead(BaseHead):
    """
    BasicHead. No pool.
    """
    ...
    def __init__(
        ...
        **kwargs
        ...
        super().__init__(num_classes, dim_in, loss_cls, **kwargs)
        if dropout_rate > 0.0:
            self.dropout = nn.Dropout(dropout_rate)
        ...
        self.projection.weight.data.mul_(head_init_scale)
        self.projection.bias.data.mul_(head_init_scale)
        # Softmax for evaluation and testing.
        if act_func == "softmax":
